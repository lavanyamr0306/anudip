...
public class ResumeService {
    ...
    public JobDetail getJobDetailByRole(String jobRole) {
        if (jobRole == null || jobRole.isBlank()) {
            return null;
        }
        return jobDetailRepository.findByJobRole(jobRole.trim()).orElse(null);
    }

    public List<String> splitSkills(String skillsRequired) {
